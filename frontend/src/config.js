...
export function config() {
  const confs = {
    ...
    prod: {
      ...
      getAllUsersUrl: `${PROD_SERVER_URL}/usermanagement/api/auth/getAllUsers`,
      ...
      getWareHousesByRegionUrl: `${PROD_SERVER_URL}/inventorymanagement/api/inventory/getWarehouseDetailsByRegion?region=`,
