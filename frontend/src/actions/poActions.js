...
export const getSentPOs = async (to, orderId, productName, deliveryLocation, status, skip, limit, fromDate, toDate, dateFilter) => { //outbound po with filter(to, orderId, productName, deliveryLocation, date, skip, limit)
  try {
    const result = await axios.get(
      `${config().fetchOutboundPurchaseOrderUrl}?to=${to}&orderId=${orderId}&productName=${productName}&deliveryLocation=${deliveryLocation}&poStatus=${status}&skip=${skip}&limit=${limit}&fromDate=${fromDate}&toDate=${toDate}&dateFilter=${dateFilter}`,
    );
    return result.data;
  } catch (e) {
    return [];
...
export const getReceivedPOs = async (from, orderId, productName, deliveryLocation, status, skip, limit, fromDate, toDate, dateFilter) => {//outbound po with filter(to, orderId, productName, deliveryLocation, date, skip, limit)
  try {
    const result = await axios.get(
      `${config().fetchInboundPurchaseOrderUrl}?from=${from}&orderId=${orderId}&productName=${productName}&deliveryLocation=${deliveryLocation}&poStatus=${status}&skip=${skip}&limit=${limit}&fromDate=${fromDate}&toDate=${toDate}&dateFilter=${dateFilter}`,
    );
    return result.data;
  } catch (e) {
    return [];
