  ...
  return (
    <div className="verifyPasswordScreen">
      ...
      <div className="login-form">
        ...
        <div>
          <p className="signUpDesc mt-1 mb-3 ">Didn’t get the code? <b onClick={onResendOtp}>Resend OTP</b></p>
        </div>
        ...
        <div className="text-center mt-5">
          ...
          <p className="signUpDesc mt-3 mb-3 ">Already have an account?  <Link to="/signup"><b>Sign Up</b></Link></p>
        </div>
      </div>
